...
class DbTableGateway extends DbSelect
{
     ...
     * @param NullPaginator|Where|\Closure|string|array  $where
     * @param NullPaginator|string|array                 $order
     * @param NullPaginator|string|array                 $group
     * @param NullPaginator|Having|\Closure|string|array $having
     */
