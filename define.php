...
define('PATH_LIBRARY', PATH_APPLICATION . '/bookonline/library');

// Đường dẫn thư mục chứa vendor
define('PATH_VENDOR', PATH_APPLICATION . '/bookonline/vendor');

define('HTMLPURIFIER_PREFIX', PATH_VENDOR);

// Đường dẫn thư mục public
define('PATH_PUBLIC', PATH_APPLICATION . '/');

// Đường dẫn thư mục captcha
define('PATH_CAPTCHA', PATH_PUBLIC . '/captcha');

// Đường dẫn thư mục template
define('PATH_TEMPLATE', PATH_PUBLIC . '/bookonline/template');

// Đường dẫn thư mục files
define('PATH_FILES', PATH_PUBLIC . '/bookonline/files');
...
define('TABLE_TIME_LINE', 'time_line');
define('TABLE_NEST', 'group_nest');
define('TABLE_SCHOOL', 'group_school');
define('TABLE_USER', 'user');
define('TABLE_NESTED', 'nested');
define('TABLE_NESTED_PERMISSION', 'nested_permission');
